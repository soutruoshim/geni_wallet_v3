    ...
    <div class="col-md-6 col-lg-6 col-xl-3 currency--card">
      <div class="card card-primary">
        <div class="card-header d-flex justify-content-between">
          <h4>{{ucfirst($item->name).' Section'}}</h4>
          @if ($item->slug != 'banner' && $item->slug != 'social' && $item->slug != 'policies' && $item->slug != 'contact')
        ...
        <div class="card-body">
            <a href="{{route('admin.frontend.edit',$item->id)}}" class="btn btn-primary"><i class="fas fa-edit"></i> @lang('Edit '.ucfirst($item->name).' Section')</a>
        </div>
      </div>
    </div>
    @endforeach
