...
@section('breadcrumb')
 <section class="section">
    <div class="section-header justify-content-between">
        <h1>@lang('Mechant Details')</h1>
        <a href="{{route('admin.merchant.index')}}" class="btn btn-primary"><i class="fas fa-backward"></i> @lang('Back')</a>
    </div>
</section>
@endsection
        ...
        <div class="col-xxl-8 col-lg-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <h6 class="mt-3">@lang('Merchant details')</h6>
                    <hr>
            ...
            <div class="card">
                <div class="card-body">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between">@lang('Total Withdraw') <span>{{$gs->curr_sym}}{{$totalWithdraw}}</span></li>
                        @if (access('merchant login'))
                        <li class="list-group-item d-flex justify-content-between">@lang('Login to Merchant') <span><a target="_blank" href="{{route('admin.merchant.login',$user->id)}}" class="btn btn-dark">@lang('Login')</a></span></li>
                        @endif
                        <li class="list-group-item d-flex justify-content-between">@lang('Merchant Login Info') <span><a href="{{route('admin.merchant.login.info',$user->id)}}" class="btn btn-dark">@lang('View')</a></span></li>
                    </ul>
                </div>
            </div>
        </div>
