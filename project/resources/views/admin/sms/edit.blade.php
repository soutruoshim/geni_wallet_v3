...
@section('breadcrumb')
 <section class="section">
    <div class="section-header justify-content-between">
        <h1>@lang('Edit Config : '.$gateway->name)</h1>
        <a href="{{route('admin.sms.index')}}" class="btn btn-primary"><i class="fas fa-backward"></i> @lang('Back')</a>
    </div>
</section>
@endsection
                    ...
                    <form action="{{route('admin.sms.update',$gateway->id)}}" method="POST">
                        ...
                        <div class="form-group border p-2 rounded">
                            <label class="cswitch mb-0 d-flex justify-content-between align-items-center">
                                ...
                                <span class="cswitch--label font-weight-bold ">@lang('Set as default gateway')</span>
                            </label>
                        </div>
                        @endif
