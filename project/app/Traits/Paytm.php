...
trait Paytm {
	    ...
	    public static function handlePaytmRequest( $order_id, $amount, $type ) {
            ...
            if($type == 'checkout'){
                ...
                $paramList["CALLBACK_URL"] = route('payment.process.paytm.notify');
            }
        ...
        static function getAllEncdecFunc() {
